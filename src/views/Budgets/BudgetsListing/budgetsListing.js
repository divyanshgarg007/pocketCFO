...
import MyDiv from './budgetsListing.style'
...
export default function BudgetsListing() {
  ...
  const handleEdit = () => {
    navigate(routesNames.EDITBUDGETS)
  }
    ...
    <MyDiv>
      <Box className="main_wrapper">
        <Flex className="page_heading">
          <Heading as="h1" className="font_dm font_dark text_bold text_xl">Budgets</Heading>
          <Spacer />
          <CustomButton onClick={handleModal} leftIcon={<AddIcon className="add" />} size="md" type="submit" title="Add budget" className="btn_main text_medium font_dm" />
        </Flex>
          ...
          <TableContainer>
            <Table variant="simple">
              ...
              <Tfoot>
                <Tr>
                  <Td>
                    <CustomButton onClick={handleModal} leftIcon={<AddIcon className="add" />} size="md" type="submit" title="Add budget" className="btn_default text_medium font_dm" />
                  </Td>
                </Tr>
              </Tfoot>
            </Table>
      ...
      <CreateBudget visibleModal={visibleModal} handleModal={handleModal} errors={errors} isSubmitting={isSubmitting}
